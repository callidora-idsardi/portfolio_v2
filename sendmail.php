...
// Validate email for missing value AND a valid email string
    ...
    if(empty($errors)){
        ...
        $query = "INSERT INTO contacts (first_name, last_name, email, comments) VALUES ('$lname', '$fname', '$email', '$msg')";
        
        if(mysqli_query($connect, $query)) {
            // Send email
            $to = 'c_idsardi@fanshaweonline.ca'; // Change to your recipient email address
